          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-4 bg-slate-900 rounded-lg border border-slate-800">
                ...
                <div className="flex items-start gap-4 p-4 bg-slate-900 rounded-lg border border-slate-800">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">Follow us for updates</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-gradient-to-br from-amber-600/20 to-amber-700/20 border border-amber-600/30 rounded-lg">
                ...
                <p className="text-slate-300">24/7 Emergency Response</p>
            ...
            <motion.div
              ...
              variants={fadeInUp}
            >
              <div className="bg-slate-900 p-8 rounded-lg border border-slate-800 shadow-2xl">
                <h2 className="text-3xl font-bold mb-6 text-white">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-amber-600 hover:bg-amber-500 disabled:bg-slate-700 disabled:cursor-not-allowed text-white font-semibold rounded-lg shadow-lg hover:shadow-amber-500/50 transition-all duration-300"
                  >
                    {status === 'submitting' ? (
                      'Sending...'
                    ) : (
